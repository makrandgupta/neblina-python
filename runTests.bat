...
"C:\Program Files\Git\git-bash.exe" runGitPullColibri.sh || ( echo git FAILED & GOTO usrChoice )
...
"C:\Program Files (x86)\GNU ARM Eclipse\openocd\bin\openocd.exe" -f interface/cmsis-dap.cfg -f target/nrf51.cfg -c "program C:/Users/Manou/Dropbox/Neblina_Production/Firmware/nRF51/s130_nrf51.hex exit" || echo programming FAILED & GOTO usrChoice
"C:\Program Files (x86)\GNU ARM Eclipse\openocd\bin\openocd.exe" -f interface/cmsis-dap.cfg -f target/nrf51.cfg -c "program C:/Users/Manou/Dropbox/Neblina_Production/Firmware/nRF51/NebnRF51_v0_10.hex exit" || echo programming FAILED
if %alltest%==0 (GOTO usrChoice)
